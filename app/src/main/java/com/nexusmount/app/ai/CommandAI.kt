...
object CommandAI {
    ...
    sealed class Action {
        ...
        data class ListDrives : Action()
        data class TransferHint : Action()
        data class InterconnectHint : Action()
        data class CollabHint : Action()
        data class TailscaleStatus : Action()
        data class StorageInfo : Action()
